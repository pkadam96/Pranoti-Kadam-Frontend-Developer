  ...
  return (
    <>
      <div className="fixed top-0 w-full text-white flex items-center gap-8 px-12 py-4 lg:px-24 lg:py-4 border-b border-inherit frosted-glass z-30">
        ...
        <div className={`fixed top-16 left-0 h-screen-full w-full lg:h-full bg-black flex gap-4 flex-col items-center justify-center transition-transform transform ${menuOpen ? 'translate-x-0' : 'translate-x-full'} lg:static lg:bg-transparent lg:flex-row lg:justify-between lg:translate-x-0 z-70 `}>
          <ul className="flex flex-col lg:flex-row flex-row gap-6">
